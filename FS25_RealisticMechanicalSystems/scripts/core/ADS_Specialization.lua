...
source(g_currentModDirectory .. "scripts/core/ADS_SpecSaveLoad.lua")
source(g_currentModDirectory .. "scripts/core/ADS_SpecStreams.lua")
source(g_currentModDirectory .. "scripts/core/ADS_SpecVehicleState.lua")
source(g_currentModDirectory .. "scripts/core/ADS_SpecWear.lua")
source(g_currentModDirectory .. "scripts/core/ADS_SpecBreakdowns.lua")
source(g_currentModDirectory .. "scripts/core/ADS_SpecService.lua")
source(g_currentModDirectory .. "scripts/core/ADS_SpecAiWorker.lua")
source(g_currentModDirectory .. "scripts/core/ADS_SpecConsole.lua")
